    ...
    <body>
        <form class="formulaire" action="my_form.php" method="post">  <!--"form" balise principal du formulaire, "method" est un attribut qui indique par quel moyen les données vont etre envoyé ? ; "Action"  c'est l'adresse de la page ou du programme qui va traiter les informations  -->
            <fieldset>
                ...
                <label for="sexe" class="no_border">Sexe : </label>   <!-- c'est une étiquette donnée au champs saisie dans ce cas l'étiquette au champs est le "sexe"(ou nous affiche le nom de du champs de saisie ) -->
            <div id="Homme">
                ...
                <label for="prenom" class="no_border">Prenom : </label> <!--Label "Prénom" sur l'étiquette du champs de saisie-->
            <div class="Prenom">
