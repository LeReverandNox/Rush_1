...
<html>
    ...
    <body>
        <form class="formulaire" action="my_form.php" method="post">  <!--"form" balise principal du formulaire, "method" est un attribut qui indique par quel moyen les données vont etre envoyé ? ; "Action"  c'est l'adresse de la page ou du programme qui va traiter les informations  -->
            ...
            <div class="Prenom">
               <input type="text" name="prenom" id="prenom" minlength=2 placeholder="Magloire" />  <!-- creer un champs de saisie de type text avec une saisie de texte pour nom de l'élèment prenom -->
            </div>
                <br /><br />
            ...
            <fieldset>
                ...
                <input type="email" name="email" id="email" placeholder="bloodsport@gmail.com" /> <!-- crée un champs de saisie de type email avec une saisie de d'adresse mail pour nom  de l'element "email" -->
                <br /><br />

                <label for="telephone" class="no_border">Telephone : </label> <!-- label "telephone" sur l'étiquette du champs de saisie -->
                <input type="tel" name="telephone" id="telephone" placeholder="01.11.82.18.40" /> <!-- crée un champs de saisie de type tel avec une saisie par numéro (affiche sur smartphone le clavier numérique ) pour nom comme element "telephone" -->
            ...
            <div class="Site_web">
                <input type="url" name="website" id="website" placeholder="http://jacquieetmicheltv.net" /> <!-- creer un champs de saisie de type url avec une saisie par url pour nom "website" -->
            </div>
                <br /><br />
